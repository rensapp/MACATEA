        ...
        <div class="row mt-4">
            <div class="col-10 ">
                <form action="../staff/staffCoupSearch.php" class="d-inline" name="form1" method="post">
                    <input type="text"  id="submit" placeholder="Search Coupon Code" name="submit" class="w-50 p-2">
            ...
            <tbody>
                <?php
                    if (isset($_POST['codeSearch'])) {
                        $search = htmlspecialchars($_POST['codeSearch']); // Prevent potential HTML injection

                        // Prepare and execute the SQL query
                        $sql = "SELECT * FROM rewards WHERE code = :search";
