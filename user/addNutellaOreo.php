				...
				<div class="modal-body">
					...
					<div class="col-md-8">
						...
						<div class="form-group">
							...
							<input style="margin-left: -30px;" type="radio" name="price" value="120, 16oz" checked> ₱<?php echo $fetch['price_16oz']?> (16oz) <br>
							<input style="margin-left: -30px;" type="radio" name="price" value="150, 22oz"> ₱<?php echo $fetch['price_22oz']?>(22oz)
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label style="margin-left: -50px;">Select Delivery type</label> <br>
							<input style="margin-left: -30px;" type="radio" name="delivery_type_update" value="Delivery" required> Deliver<br>
							<input style="margin-left: -30px;" type="radio" name="delivery_type_update" value="Pick-up"> Pick-up
						</div>
						<?php } ?>
						
						<?php
						   echo '<button name="update_cart" class="btn" style="width: 250px; margin-left: -50px; margin-bottom: 20px;"><span></span> ADD</button>';
						?>
					</div>
				</div>
