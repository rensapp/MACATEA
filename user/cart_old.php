                    ...
                    <thread>
                        <tr>
                            ...
                            <th scope="col" style="border-radius: 0 15px 0 0;">
                                <a href ="action.php?clear=<?php echo $id?>" onClick="return confirm('Are you sure to clear your cart?');" class="btn1 btn-sm btn-danger"style="font-weight: bold;">Empty Cart</a>   
                            </th>
                        </tr>
                    </thread>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="action.php?remove=<?php echo $row["oid"];?>" onclick="return confirm('are you sure you want to remove this item?');" class="btn2 btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                            </td> 
        ...
        <div class="col mb-2">
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <a href="NutellaOreo_series.php" class="btn btn-block btn-light"><i class="fa fa-shopping-cart"></i> ADD MORE </a>
                </div>
                <div class="col-sm-12 col-md-6" text-right>
                    <a href="address.php" class="btn btn-md btn-block btn-success text-uppercase <?=($grand_total > 1 )?"":"disabled";?>"> Checkout</a>
                </div>
            </div>
        </div>
    </div>
