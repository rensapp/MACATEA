<?php
	...
	$res=mysqli_query($db,"SELECT * FROM users");
		...
		header("location: ../user/MacCoffee_seriesE.php?category=8");
		?>
		<!-- <script>
			 window.history.go(-1);
		</script> -->
...
<div class="modal fade" id="update_modal<?php echo $fetch['id']?>" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<form method="POST" action="modal_product_macCoffee.php">
				...
				<div class="modal-body ms-2">
					...
					<div class="col-12">
						...
						<div class="form-group">
							...
							<input type="radio" name="addons" value="10, Cold brew"> Cold Brew +₱10 <br>
							<input type="radio" name="addons" value="10, Coffee jelly"> Coffee Jelly +₱10 <br>
							<input type="radio" name="addons" value="20, Cream cheese"> Cream Cheese +₱20 <br>
						</div>
						<br>
