...
<body>
    ...
    <div class="container-fluid p-5">
		<div class="row">
			<div class="col-12">
				<h1 class="text-center text-dark fw-semibold">Mactea Special</h1>
			</div>
		</div>
		<div class="row">
			...
			<?php
				...
				$select_products = mysqli_query($conn, "SELECT * FROM `product` WHERE  category=7");
            ...
            <h4 class="mt-2 black">₱<?php echo $fetch['large']; ?></h4>
