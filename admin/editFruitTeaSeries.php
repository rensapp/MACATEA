...
button[name=cancel] {
	...
	<div class="header">
		<h2>Update Fruit Tea/Yakult Series</h2>
	</div>
		...
		<div class="input-group">
			<button type="submit" class="btn" name="updateFruitTeaSeries"> Update </button>
...
if(isset($_POST["cancel"]))
{
	...
	window.location = "http://localhost/MACATEA/admin/FruitTeaSeries_List.php";
	</script>
	<?php
}
?>
