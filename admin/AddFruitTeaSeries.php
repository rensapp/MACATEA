...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Add Fruit Tea/Yakult Series</title>
	...
	<body>
		...
		<div class="headerA">
	<h2>ADD FRUIT TEA/YAKULT SERIES</h2>
</div>

<form method="POST" action="AddFruitTeaSeries.php"  enctype="multipart/form-data">
...
<link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Open+Sans:wght@300&display=swap" rel="stylesheet">
	...
	<div class="input-groupA">
		...
		<input type="number" name="medium" autocomplete="off" value="78" readonly>
		<p class="error"> <?php if (isset($errors['medium'])) echo $errors ['medium'];?></p>
	</div>
	<div class="input-groupA">
		<label>Price Large</label>
		<input type="number" name="large" autocomplete="off" value="88" readonly>
		<p class="error"> <?php if (isset($errors['large'])) echo $errors ['large'];?></p>
	</div>
	<div class="input-groupA">
		<label>Price 1 Liter</label>
		<input type="number" name="oneliter" autocomplete="off" value="140">
	...
	<div class="input-groupA">
		<button type="submit" class="btnA" name="AddFruitTeaSeries">ADD PRODUCT</button>
