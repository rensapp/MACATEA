...
button[name=cancel] {
	...
	<p class="error"> <?php if (isset($errors['name'])) echo $errors ['name'];?></p>	
		...
		<div class="input-group">
			<button type="submit" class="btn" name="updateNutellaSeries"> Update </button>
...
if(isset($_POST["cancel"]))
{
	...
	window.location = "http://localhost/MACATEA/admin/NutellaSeries_List.php";
	</script>
	<?php
}
?>
