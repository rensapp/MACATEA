...
<div class="main-container">
 ...
 <form action="SearchUser.php" name="form1" method="post" style=" background-color: #4CAF50; position:absolute; top:  -20px; left :220px;" >
...
<?php
	...
	<tr>
					...
					<td> <a href="editUser.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #4682B4;">Edit</button></a>
