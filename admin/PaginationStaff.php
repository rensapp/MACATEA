<?php
 include('db_conn.php');
	...
	$user_type = 'staff';
    $query=mysqli_query($conn,"select count(ID) from `users` WHERE user_type like '%$user_type%'");
    ...
    $nquery=mysqli_query($conn,"select * from `users` WHERE user_type like '%$user_type%' $limit");
