...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Search Fruit Tea/Yakult Series</title>
 ...
 <span class="title"> SEARCH FRUIT TEA/YAKULT SERIES</span> 
...
if(isset($_POST['search'])){
	...
	$sql = $sql = "SELECT * FROM product WHERE `name`='$search' AND category='5'";
