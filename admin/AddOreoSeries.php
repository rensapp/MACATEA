...
<html lang="en" dir="ltr">
	...
	<body>
		...
		<div class="headerA">
	<h2>ADD OREO SERIES</h2>
</div>

<form method="POST" action="AddOreoSeries.php"  enctype="multipart/form-data">
...
<link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Open+Sans:wght@300&display=swap" rel="stylesheet">
	...
	<div class="input-groupA">
		<button type="submit" class="btnA" name="AddOreoSeries">ADD PRODUCT</button>
