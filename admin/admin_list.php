...
<div class="main-container">
 ...
 <form action="SearchAdmin.php" name="form1" method="post" style=" background-color: #4CAF50; position:absolute; top:  -20px; left :220px;" >
...
<?php
	$user_type = 'admin';
	$res=mysqli_query($db,"SELECT * FROM users WHERE user_type like '%$user_type%'");
	...
	<tr>
					...
					<td> <a href="editAdmin.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #4682B4;">Edit</button></a>
					<a href="DeleteAdmin.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #B22222;">Delete</button></a> </td>
                </tr>
