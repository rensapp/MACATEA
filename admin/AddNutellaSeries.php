...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Add Nutella Series</title>
	...
	<body>
		...
		<div class="headerA">
	<h2>ADD NUTELLA SERIES</h2>
</div>

<form method="POST" action="AddNutellaSeries.php"  enctype="multipart/form-data">
...
<link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Open+Sans:wght@300&display=swap" rel="stylesheet">
	...
	<div class="input-groupA">
		<button type="submit" class="btnA" name="AddNutellaSeries">ADD PRODUCT</button>
