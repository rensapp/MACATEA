...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Search Milktea Series</title>
 ...
 <span class="title"> SEARCH MILKTEA SERIES </span> 
...
if(isset($_POST['search'])){
	...
	$sql = $sql = "SELECT * FROM product WHERE `name`='$search' AND category='1'";
	...
	<tr>
				<td><?php echo $crow["name"]; ?></td>
					...
					<a href="Delete.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #B22222;">Delete</button></a> </td>
                </tr>
	 <?php
		}
	}else{
