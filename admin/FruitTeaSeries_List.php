...
<head>
    ...
    <title>Fruit Tea/Yakult Series List</title>
</head>
...
<div class="main-container">
 ...
 <form action="SearchFruitTeaSeries.php" name="form1" method="post" style=" background-color: #4CAF50; position:absolute; top:  -20px; left :220px;" >
	...
	<div class="container" style="position:relative;">
		...
		<?php
 include "PaginationFruitTeaSeries.php";
 ?>
		<link rel="stylesheet"  href="desi.css?v=<?php echo time();?>"/>
 <span class="title"> FRUIT TEA/YAKULT SERIES</span> 
...
<?php
	$res=mysqli_query($db,"SELECT * FROM product WHERE category = '5'");
	...
	<tr>
                    ...
                    <td><?php echo $crow["medium"]; ?></td>
                    <td><?php echo $crow["large"]; ?></td>
					<td><?php echo $crow["oneliter"]; ?></td>
                    <td><img src="../product/<?php echo $crow["image_dir"]; ?>" width="50px" height="50px"></td>
					<td> <a href="editFruitTeaSeries.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #4682B4;">Edit</button></a>
					<a href="DeleteFruitTeaSeries.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #B22222;">Delete</button></a> </td>
                </tr>
