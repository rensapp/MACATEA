...
<head>
    ...
    <title>Milktea Series List</title>
</head>
...
<div class="main-container">
 ...
 <form action="SearchMilkteaSeries.php" name="form1" method="post" style=" background-color: #4CAF50; position:absolute; top:  -20px; left :220px;" >
	...
	<div class="container" style="position:relative;">
		...
		<?php
 include "PaginationMilkteaSeries.php";
 ?>
		<link rel="stylesheet"  href="desi.css?v=<?php echo time();?>"/>
 <span class="title"> MILKTEA SERIES</span> 
...
<?php
	$res=mysqli_query($db,"SELECT * FROM product WHERE category = '1'");
	...
	<tr>
					...
					<td> <a href="editMilkteaSeries.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #4682B4;">Edit</button></a>
					<a href="DeleteMilkteaSeries.php?id=<?php echo $crow["id"]; ?>"><button  class="delete" style="background-color: #B22222;">Delete</button></a> </td>
                </tr>
