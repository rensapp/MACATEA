...
button[name=cancel] {
	...
	<div class="header">
		...
		<div class="input-group">
			<button type="submit" class="btn" name="updateMacColdBrew"> Update </button>
...
if(isset($_POST["cancel"]))
{
	...
	window.location = "http://localhost/MACATEA/admin/MacColdBrewList.php";
	</script>
	<?php
}
?>
