...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Add Milktea Series</title>
	...
	<body>
		...
		<div class="headerA">
	<h2>ADD MILKTEA SERIES</h2>
</div>

<form method="POST" action="AddMilkteaSeries.php"  enctype="multipart/form-data">
...
<link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Open+Sans:wght@300&display=swap" rel="stylesheet">
	...
	<div class="input-groupA">
		...
		<input type="number" name="oneliter" autocomplete="off" value="125" readonly>
	...
	<div class="input-groupA">
		<button type="submit" class="btnA" name="AddMiltkeaSeries">ADD PRODUCT</button>
