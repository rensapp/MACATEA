...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Add Mactea Special</title>
	...
	<body>
		...
		<div class="headerA">
	<h2>ADD MACTEA SPECIAL</h2>
</div>

<form method="POST" action="AddMacteaSpecial.php"  enctype="multipart/form-data">
...
<link href="https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Open+Sans:wght@300&display=swap" rel="stylesheet">
	...
	<div class="input-groupA">
		<button type="submit" class="btnA" name="AddMacteaSpecial">ADD PRODUCT</button>
