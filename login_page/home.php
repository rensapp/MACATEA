<?php include '../includes/sign-inheadergoogle.php'; ?>
<?php
...
<div class="left-container" style="margin-left: 200px; float: left; ">
 ...
 <div class="div2"> 
	...
	$id = $_SESSION['login_id'];
	$get_user = mysqli_query($db_connection, "SELECT * FROM `users` WHERE `google_id`='$id'");
	while($crow=mysqli_fetch_array($get_user))
	{
	?>
<a class="Click" style="text-decoration: none;" href="MyProfile.php?id=<?php echo $crow["id"]; ?>">My Profile</a>
  ...
  <div class="div3"> 
   ...
   <div class="div4"> 
	<div> 
	<a class="Click" href="http://localhost/mactea/MyContactNumber.php">My Contact Numbers</a> 
	</div>
 </div>
...
.input-group input {
 ...
 <img src="images/mactea.png" style="width: 300px;"> 
