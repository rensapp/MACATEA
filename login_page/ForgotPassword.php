...
<?php
    ...
    if(isset($_POST["register"])){
      ...
      <p style='margin-bottom:20px'>If you did not request this code, you can ignore this message.</p>  
</div></div>";
...
<body style="background-image: url('../images/macteabg.png'); background-repeat: no-repeat;">
    <div class="container border border-dark rounded mt-5" style="background-color: white;">
        <div class="row p-3 border-bottom border-dark" style="background-color: #008000;">
            <h2 class="text-center text-light border-bottom pb-2">Forgot Password</h2>
        </div>
        ...
        <div class="input-group mt-5 row" >
            ...
            <p class="error text-danger text-center m-0"> <?php if (isset($errors['email1'])) echo $errors ['email1'];?> </p>
            <p class="error text-danger text-center mb-3"> <?php if (isset($errors['email_login'])) echo $errors ['email_login'];?></p>
        </div>
        <div class="row p-3">
            <div class="col"></div>
            <div class="col-4">
